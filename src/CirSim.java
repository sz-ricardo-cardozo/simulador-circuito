...
public class CirSim extends Frame
	...
	public void init() {
		...
		// activeMenu.add(getClassCheckItem("Adicionar Varactor/Varicap",
		// "VaractorElm"));
		...
		// activeMenu.add(getClassCheckItem("Adicionar Fotoresistor",
		// "PhotoResistorElm"));
		...
		otherMenu.add(getCheckItem(
				isMac ? "Arrastar Linha (Alt-S-arrastar, S-direita)" : "Arrastar Linha (S-direita)",
				"DragRow"));
		otherMenu.add(getCheckItem(
				isMac ? "Arrastar Coluna (Alt-\u2318-arrastar, \u2318-direita)" : "Arrastar Coluna (C-direita)",
				"DragColumn"));
		...
		stoppedCheck = new Checkbox("Pausar");
